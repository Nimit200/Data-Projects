...
Distance_km = st.slider('Distance_Km',step=1)
...
Num_Traffic_Signals = st.slider('Num_Traffic_Signals',step=1,min_value=0,max_value=15)           
Speed_Limit_kmph = st.slider('Speed_Limit_kmph',step=1)              
Incident_Type = st.selectbox('Incident_Type',('Other' ,'Medical' ,'Fire' ,'Crime'))                 
Population_Density_per_km2 = st.slider('Population_Density_per_km2')
